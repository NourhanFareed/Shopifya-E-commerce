...
export default function ClientsReviews() {
    return (
        <div className="bg-white mt-20 mb-10 mx-20 pb-8 dark:bg-gray-900 shadow-md rounded-lg">
            <div className="container px-6 py-10 mx-auto">
                <h1 className="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">
                    What our <span className="text-[#240253] dark:text-[#003783] ">clients</span> say
                </h1>
                ...
                <div className="grid grid-cols-1 gap-8 mx-auto mt-8 lg:grid-cols-2 xl:mt-10 max-w-7xl">
                    <div className="p-6 bg-gray-100 shadow-lg rounded-lg dark:bg-gray-800 md:p-8">
                        ...
                        <div className="flex items-center mt-6">
                            ...
                            <div className="mx-4">
                                <h1 className="font-semibold text-[#240253] dark:text-[#003783]">Robbert</h1>
                    ...
                    <div className="p-6 bg-gray-100 shadow-lg rounded-lg dark:bg-gray-800 md:p-8">
                        ...
                        <div className="flex items-center mt-6">
                            ...
                            <div className="mx-4">
                                <h1 className="font-semibold text-[#240253] dark:text-[#003783]">Mia Brown</h1>
